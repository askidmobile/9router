...
export function createSSEStream(options = {}) {
  ...
  const state = mode === STREAM_MODE.TRANSLATE
    ? { ...initState(sourceFormat), provider, toolNameMap, customToolNames: new Set(customToolNames || []), toolNamespaces: new Map(toolNamespaces || []), model, sessionId: credentials?._clientSessionId || null,
...
export function createSSETransformStreamWithLogger(targetFormat, sourceFormat, provider = null, reqLogger = null, toolNameMap = null, model = null, connectionId = null, body = null, onStreamComplete = null, apiKey = null, customToolNames = null, toolNamespaces = null, credentials = null) {
