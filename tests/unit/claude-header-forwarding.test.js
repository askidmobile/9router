...
describe("proxyAwareFetch — api.anthropic.com routing", () => {
  ...
  it("api.anthropic.com goes through native fetch (gotScraping path disabled)", async () => {
    // The got-scraping TLS-fingerprint route was disabled upstream in v0.4.62;
    // anthropic requests ride the pooled native fetch like everything else.
